...
State_manager::State_manager(int _user_state_save_interval_seconds, int _tracker_save_interval_seconds, std::shared_ptr<User_state> _user_state, std::shared_ptr<Tracker> _tracker) : user_state_save_interval_seconds(_user_state_save_interval_seconds), user_state(_user_state), tracker_save_interval_seconds(_tracker_save_interval_seconds), tracker(_tracker) {}
